...
var solutionFile = solutionDir + File("AmbientContext.DotNet.sln");
var buildDir = Directory("./src/AmbientContext.DotNet/bin") + Directory(configuration);
    ...
    .Does(() => 
{
    ...
    DotNetCorePack("./src/AmbientContext.DotNet/project.json", settings);
});
